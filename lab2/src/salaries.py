...
if __name__ == "__main__":
    ...
    sns_plot.savefig("out/scaterplot.png", bbox_inches='tight')
    sns_plot.savefig("out/scaterplot.pdf", bbox_inches='tight')
    ...
    sns_plot2.savefig("out/histogram.png", bbox_inches='tight')
    sns_plot2.savefig("out/histogram.pdf", bbox_inches='tight')
